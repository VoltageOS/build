...
enforce_rro_product_name := $(subst lineage_,vos_,$(PRODUCT_NAME))
enforce_rro_override_module := $(subst Lineage,Vos,$(subst lineage,vos,$(subst lineageos,voltageos,$(enforce_rro_source_module))))
